...
# 各オブジェクトファイルのパスを指定
DEPENDENCIES = $(BUILD_DIR)/item.o $(BUILD_DIR)/bin.o $(BUILD_DIR)/knapsack.o $(BUILD_DIR)/gap.o $(BUILD_DIR)/test.o $(BUILD_DIR)/station.o $(BUILD_DIR)/charging.o $(BUILD_DIR)/schedule_option.o
